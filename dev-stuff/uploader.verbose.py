...
class firmware(object):
    ...
    def __init__(self, path):
        ...
        self.image0 = self.desc['image']
        self.image1 = bytearray(base64.b64decode(self.desc['image']))
        self.image2 = bytearray(zlib.decompress(base64.b64decode(self.desc['image'])))
        self.image = bytearray(zlib.decompress(base64.b64decode(self.desc['image'])))
        print("\n\n\n\nself.image0:"+str(list(self.image0)))
        print("\n\n\n\n\n\nself.image1:"+str(list(self.image1)))
        print("\n\n\n\n\n\nself.image2:"+str(list(self.image2)))
        sys.exit()
...
class uploader(object):
    ...
    def __send(self, c):
        self.port.write(c)
        #print("send:" + str(c))
        #print("send:" + str(c.hex()))
        print("send:" + str(list(c)))
    ...
    def __recv(self, count=1):
        ...
        #print("recv:" + str(c))
        #print("recv:" + str(c.hex()))
        print("recv:" + str(list(c)))
        return c
